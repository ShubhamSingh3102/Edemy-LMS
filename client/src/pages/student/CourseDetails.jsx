...
const CourseDetails = () => {
  ...
  const [isAlreadyEnrolled, setIsAlreadyEnrolled] = useState(false) // enrolled nhi h initially
  ...
  // id se particular course nikalo allCourses se...
  ...
  // enrolledCourses or purchase course
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {chapter.chapterContent.map((lecture, index) => (
                        ...
                        ${currentLecture == lecture.lectureUrl ? 'bg-blue-50 border-l-4 border-blue-500' : ''}`}>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            ...
                            <div className='flex gap-2'>
                              {lecture.isPreviewFree && <p onClick={() => {
                                ...
                                setCurrentLecture(lecture.lectureUrl)
                              }}
