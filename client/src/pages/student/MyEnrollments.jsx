...
const MyEnrollments = () => {
  ...
  // add dummy data and later we will add the data from our database while building backend
  ...
  const getCourseProgress = async () => {
    try {
      ...
      // get progress data of multiple courses and handle multiple async operations
